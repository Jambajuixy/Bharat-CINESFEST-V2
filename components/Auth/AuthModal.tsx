...
const AuthModal: React.FC = () => {
  ...
  const resetModal = () => {
    ...
    setTimeout(() => {
      ...
      setInputValue('');
      setFormData({ name: '', bio: '', role: UserRole.AUDIENCE, gender: 'Prefer not to say' });
    }, 300);
  };
  ...
  return (
    ...
    >
      <div className="py-2">
             ...
             <form onSubmit={handleInputSubmit} className="space-y-4">
               <div className="relative">
                 ...
                 <input 
                   ...
                   placeholder={activeMethod === 'email' ? 'director@studio.com' : '555-0123'}
            ...
            <div className="relative w-24 h-24 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <svg className="w-10 h-10 text-amber-500/50" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9 9V5a1 1 0 112 0v4h1a1 1 0 112 0v4h1a1 1 0 110 2h-2v1a1 1 0 11-2 0v-2H7a1 1 0 110-2h2z" clipRule="evenodd" />
                </svg>
              </div>
            </div>
        ...
        {step === 'signup' && (
          <form onSubmit={handleSubmitProfile} className="space-y-5 animate-in slide-in-from-bottom-4 duration-500">
            <div className="bg-amber-500/5 border border-amber-500/10 p-4 rounded-xl mb-4">
              ...
              <p className="text-[11px] text-neutral-400 mt-1">We couldn't find a profile for this identity. Let's create one!</p>
            </div>
            ...
            <div>
              ...
              <input 
                ...
                placeholder="e.g. Cinephile Prime"
              ...
              <div>
                ...
                >
                  {Object.values(UserRole)
                    .filter(role => role !== UserRole.ADMIN) // BUG FIX: Do not allow regular users to select Admin role
                    .map(role => (
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Share your passion for the silver screen..."
                className="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-sm text-white focus:border-amber-500 outline-none h-20 resize-none transition-all"
              />
            </div>
            ...
            <button 
              ...
              className={`w-full py-4 bg-red-carpet gold-glow rounded-xl text-white font-bold uppercase tracking-[0.2em] text-[10px] hover:scale-[1.02] transition-all shadow-xl flex items-center justify-center gap-3`}
            >
